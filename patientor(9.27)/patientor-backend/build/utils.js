...
const _C_Users_avinDownloadsPart9patientor_backend_9_27__uild_1 = require(".C:Users\ravinDownloadsPart9patientor-backend(9.27)\build");
const isString = (text) => {
...
const isGender = (param) => {
    return Object.values(_C_Users_avinDownloadsPart9patientor_backend_9_27__uild_1.Gender).includes(param);
};
...
const isHealthCheckRating = (param) => {
    return Object.values(_C_Users_avinDownloadsPart9patientor_backend_9_27__uild_1.HealthCheckRating).includes(param);
};
